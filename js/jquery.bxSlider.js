...
(function(a) {
	a.fn.bxSlider = function(b) {
		...
		function H() {
			I(b.startingSlide);
			if (b.mode == "horizontal") {
				e.wrap('<div class="' + b.wrapperClass + '" style="position:relative;"></div>').wrap('<div class="bx-window" style="position:relative; overflow:hidden;"></div>').css({
					width : "999999px",
					position : "relative",
					left : "-" + y + "px"
				});
		...
		this.startShow = function(a) {
			var h1 = $( "#col-right" ).height();
			var h2 = $( "#left-menu" ).height();
			$( ".bx-window" ).height(h1-h2-130);
			if ( typeof a == "undefined") {
				var a = true
			}
			K();
